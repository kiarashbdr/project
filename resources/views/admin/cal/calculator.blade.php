...
<script src='"{{url("/")}}/assest/js/jquery-3.6.0.min.js"'></script>
<script src='"{{url("/")}}/assest/js/all.min.js"'></script>
<script src='"{{url("/")}}/assest/js/bootstrap.min.js"'></script>
<script src='"{{url("/")}}/assest/js/swiper-bundle.min.js"'></script>
<script src='"{{url("/")}}/assest/js/mdb.min.js"'></script>
