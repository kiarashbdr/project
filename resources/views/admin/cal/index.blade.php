...
<head>
    ...
    <link rel="stylesheet" href="{{url("/")}}/admin/css/style1.css" />
    <script src="{{url("/")}}/calc/js/jquery-3.6.0.min.js"></script>
<script src="{{url("/")}}/admin/js/all.min.js"></script>
<script src="{{url("/")}}/admin/js/bootstrap.min.js"></script>
<script src="{{url("/")}}/admin/js/swiper-bundle.min.js"></script>
<script src="{{url("/")}}/admin/js/mdb.min.js"></script>
<script src="{{url("/")}}/admin/js/scriptt.js"></script>
