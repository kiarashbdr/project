...
<nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg">
      <div class="position-sticky">
        ...
        <a href="http://localhost:8000/adm" class="list-group-item list-group-item-action py-2 divv ripple bg-dark text-center" aria-current="true">
          <span class="btext">مدیریت صفحه اصلی</span><i class="fas fa-tachometer-alt fa-fw me-3 text-white text-center"></i>
          </a>
          <a href="http://localhost:8000/adm/baners" class="list-group-item list-group-item-action py-2 divv ripple bg-dark">
          <span class="ba text">مدیریت بنر</span><i class="fas fa-chart-area fa-fw me-3 text-white text-center"></i>
          </a>
          ...
          <span class="bb text">مدیریت پست ها</span><i class="fas fa-lock fa-fw me-3 text-white text-center"></i>
        </a>
          <a href="http://localhost:8000/adm/media" class="list-group-item list-group-item-action py-2 divv ripple bg-dark">
          <span class="bc text">مدیریت رسانه</span><i class="fas fa-chart-line fa-fw me-3 text-white text-center"></i>
          </a>
          <a href="http://localhost:8000/adm/cal" class="list-group-item list-group-item-action py-2 divv ripple bg-dark">
          <span class="bd text">ماشین حساب</span><i class="fas fa-chart-pie fa-fw me-3 text-white text-center"></i>
          </a>
          <a href="http://localhost:8000/adm/navs" class="list-group-item list-group-item-action py-2 divv ripple bg-dark">
          <span class="bf text">مدیریت منو </span><i class="fas fa-chart-bar fa-fw me-3 text-white text-center"></i>
          </a>
          <a href="#" class="list-group-item list-group-item-action py-2 divv ripple bg-dark">
          <span class="bh text">مدیریت صفحات</span><i class="fas fa-building fa-fw me-3 text-white text-center"></i>
          </a>
          <a href="http://localhost:8000/adm/media/create" class="list-group-item list-group-item-action py-2 divv ripple bg-dark">
          <span class="bi text">بست ها</span><i class="fas fa-calendar fa-fw me-3 text-white text-center"></i>
          </a>
        </div>
      </div>
    </nav>
...
?> 
                    ...
                    <div class="card-body bg-dark">
                        <form action="{{url('/')}}/adm/product" method="POST" enctype="multipart/form-data">
                            @csrf
