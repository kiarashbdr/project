...
<nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg">
      <div class="position-sticky">
        ...
        <a href="http://localhost:8000/adm" class="list-group-item list-group-item-action py-2 divv ripple bg-dark text-center" aria-current="true">
          ...
          <span class="bbg text-white">مدیریت محصولات </span><i class="fas fa-globe fa-fw me-3 y text-white"></i>
          </a>
          <a href="http://localhost:8000/adm/post" class="list-group-item list-group-item-action py-2 divv ripple bg-dark">
          <span class="bb ">مدیریت پست </span><i class="fas fa-lock fa-fw me-3 text-white"></i>
        </a>
          ...
          <span class="bd ">ماشین حساب</span><i class="fas fa-chart-pie fa-fw me-3 text-white"></i>
          </a>
            ...
            <section class="mb-4">
                <div class="card bg-dark divv">
                    <div class="card-header py-3 bg-dark">
                        <h5 class="mb-0 text-center text-white bg-dark"><strong>مدیریت صفحه محصولات</strong></h5>
                    </div>
                    <hr>
                    <div class="card-body bg-dark">
                        <form action="{{url('/')}}/adm/product" method="POST" enctype="multipart/form-data">
                            @csrf
                            <select class="divv bg-dark text-white" name="product" id="product">
                                <option value="media_id"></option>
                            </select>
                            <p class="text-white"> عکس جدید برای محصولات</p>
