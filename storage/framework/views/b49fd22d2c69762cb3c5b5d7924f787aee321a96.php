...
?>
                    ...
                    <div class="card-body text-white d-flex">
                        <form class="text-center w-100" action="<?php echo e(url('/')); ?>/adm/media" method="POST" enctype="multipart/form-data">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\kiarash\Desktop\an\resources\views/admin/media/create.blade.php ENDPATH**/ ?>