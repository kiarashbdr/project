...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(url("/")); ?>/admin/css/all.min.css" />
    <link rel="stylesheet" href="<?php echo e(url("/")); ?>/admin/css/mdb.rtl.min.css"' />
    <link rel="stylesheet" href="<?php echo e(url("/")); ?>/admin/css/style1.css" />
    <script src="<?php echo e(url("/")); ?>/calc/js/jquery-3.6.0.min.js"></script>
<script src="<?php echo e(url("/")); ?>/admin/js/all.min.js"></script>
<script src="<?php echo e(url("/")); ?>/admin/js/bootstrap.min.js"></script>
<script src="<?php echo e(url("/")); ?>/admin/js/swiper-bundle.min.js"></script>
<script src="<?php echo e(url("/")); ?>/admin/js/mdb.min.js"></script>
<script src="<?php echo e(url("/")); ?>/admin/js/scriptt.js"></script>
                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-between p-3 pt-1">
                            <div class="d-flex check">
                                <button class="btn btn-primary me-3 button" id="check">back <br><i class="fas fa-angle-left"></i></button>
...
<?php /**PATH C:\Users\kiarash\Desktop\an\resources\views/admin/cal/index.blade.php ENDPATH**/ ?>