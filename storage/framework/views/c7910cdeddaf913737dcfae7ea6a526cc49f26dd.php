            ...
            <section class="mb-4 bg-dark divv">
                <div class="card bg-dark">
                    <div class="card-header py-3 text-white">
                        <h5 class="mb-0 text-center"><strong>لیست مدیا</strong></h5>
                        </div>
                        <?php            
            if(isset($booon)){
                foreach($booon as $vff){
                echo $vff->media_id;
                echo "<br/>";
                // $src = App\Models\media::find($vff->media_id)->photo_path;
                // echo $src;
                // echo "<br/>";
...
?>
                    ...
                    <div class="card-body bg-dark">
                        <form action="<?php echo e(url('/')); ?>/adm/vff" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\kiarash\Desktop\an\resources\views/admin/vff/index.blade.php ENDPATH**/ ?>