            ...
            <section class="mb-4">
                <div class="card bg-dark divv">
                    ...
                    <div class="card-body w-100 text-white text-center">
                        <form action="<?php echo e(url('/')); ?>/adm/navs" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                          <div class="w-100">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\kiarash\Desktop\an\resources\views/admin/navs/create.blade.php ENDPATH**/ ?>