                ...
                <div class="card bg-dark divv">
                    ...
                    <div class="card-body bg-dark">
                        <form action="<?php echo e(url('/')); ?>/adm/vff" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <select class="divv bg-dark text-white" name="vff" id="vff">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\kiarash\Desktop\an\resources\views/admin/vff/create.blade.php ENDPATH**/ ?>