            ...
            <section class="mb-4 bg-dark divv">
                <div class="card bg-dark">
                    <div class="card-header py-3 text-white">
                        <h5 class="mb-0 text-center"><strong>مدیریت منو </strong></h5>
                        </div>
                        <?php            
            if(isset($bwn)){
                foreach($bwn as $navs){
                echo $navs->media_id;
                echo "<br/>";
                // $src = App\Models\media::find($navs->media_id)->photo_path;
                echo $navs;
                // echo "<br/>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\kiarash\Desktop\an\resources\views/admin/navs/index.blade.php ENDPATH**/ ?>