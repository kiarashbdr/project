...
<nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg">
      <div class="position-sticky">
        ...
        <a href="http://localhost:8000/adm" class="list-group-item list-group-item-action py-2 divv ripple bg-dark text-center" aria-current="true">
          <span class="ptext">مدیریت صفحه اصلی</span><i class="fas fa-tachometer-alt fa-fw me-3 text-white"></i>
          </a>
          <a href="http://localhost:8000/adm/baners" class="list-group-item list-group-item-action py-2 divv ripple bg-dark">
          <span class="pa text">مدیریت بنر</span><i class="fas fa-chart-area fa-fw me-3 text-white"></i>
          </a>
          ...
          <span class="pb text">مدیریت پست ها</span><i class="fas fa-lock fa-fw me-3 text-white"></i>
        </a>
          <a href="http://localhost:8000/adm/media/create" class="list-group-item list-group-item-action py-2 divv ripple bg-dark">
          <span class="pc text">مدیریت رسانه</span><i class="fas fa-chart-line fa-fw me-3 text-white"></i>
          </a>
          <a href="http://localhost:8000/adm/cal" class="list-group-item list-group-item-action py-2 divv ripple bg-dark">
          <span class="pd text">ماشین حساب</span><i class="fas fa-chart-pie fa-fw me-3 text-white"></i>
          </a>
          <a href="http://localhost:8000/adm/navs" class="list-group-item list-group-item-action py-2 divv ripple bg-dark">
          <span class="pf text">مدیریت منو </span><i class="fas fa-chart-bar fa-fw me-3 text-white"></i>
          </a>
          <a href="#" class="list-group-item list-group-item-action py-2 divv ripple bg-dark">
          <span class="ph text">مدیریت صفحات</span><i class="fas fa-building fa-fw me-3 text-white"></i>
          </a>
          <a href="http://localhost:8000/adm/post/create" class="list-group-item list-group-item-action py-2 divv ripple bg-dark">
          <span class="pi text">بست ها</span><i class="fas fa-calendar fa-fw me-3 text-white"></i>
          </a>
        </div>
      </div>
    </nav>
            ...
            <section>
                <div class="card bg-dark divv">
                    <div class="card-header py-3">
                        <h5 class="mb-0 text-center text-white"><strong>مدیریت صفحه پست</strong></h5>
                       ...
                       <?php
                         if(isset($pst)){
                            foreach($pst as $post){
                                echo $post->media_id;
                                echo "<br/>";
                                // $src = App\Models\media::find($post->media_id)->photo_path;
                                echo $post;
                                // echo $src;
                                // echo "<br/>";
                    ...
                    <div class="card-body bg-dark">
                        <form action="<?php echo e(url('/')); ?>/adm/post" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <select class="divv bg-dark text-white text-center" name="post" id="post">
                                <option value="media_id"></option>
                            </select>
                            <p class="text-light"> عکس جدید برای پست</p>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\kiarash\Desktop\an\resources\views/admin/post/index.blade.php ENDPATH**/ ?>