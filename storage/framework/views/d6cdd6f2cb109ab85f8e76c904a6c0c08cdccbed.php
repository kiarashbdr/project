...
<nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg">
      <div class="position-sticky">
        ...
        <a href="http://localhost:8000/adm" class="list-group-item list-group-item-action py-2 divv ripple bg-dark text-center" aria-current="true">
          <span class="ptext">مدیریت صفحه اصلی</span><i class="fas fa-tachometer-alt fa-fw me-3 text-white text-center"></i>
          </a>
          <a href="http://localhost:8000/adm/baners" class="list-group-item list-group-item-action py-2 divv ripple bg-dark">
          <span class="pa text">مدیریت بنر</span><i class="fas fa-chart-area fa-fw me-3 text-white text-center"></i>
          </a>
          <a href="http://localhost:8000/adm/product" class="list-group-item list-group-item-action py-2 divv ripple bg-dark">
          <span class="pg text">مدیریت محصولات </span><i class="fas fa-globe fa-fw me-3 y text-white"></i>
          </a>
          <a href="http://localhost:8000/adm/post" class="list-group-item list-group-item-action py-2 divv ripple bg-dark">
          <span class="pb text">مدیریت پست ها</span><i class="fas fa-lock fa-fw me-3 text-white text-center"></i>
        </a>
          <a href="http://localhost:8000/adm/media" class="list-group-item list-group-item-action py-2 divv ripple bg-dark">
          <span class="pc text">مدیریت رسانه</span><i class="fas fa-chart-line fa-fw me-3 text-white text-center"></i>
          </a>
          <a href="http://localhost:8000/adm/cal" class="list-group-item list-group-item-action py-2 divv ripple bg-dark">
          <span class="pd text">ماشین حساب</span><i class="fas fa-chart-pie fa-fw me-3 text-white text-center"></i>
          </a>
          <a href="http://localhost:8000/adm/navs" class="list-group-item list-group-item-action py-2 divv ripple bg-dark">
          <span class="pf text">مدیریت منو </span><i class="fas fa-chart-bar fa-fw me-3 text-white text-center"></i>
          </a>
          <a href="#" class="list-group-item list-group-item-action py-2 divv ripple bg-dark">
          <span class="ph text">مدیریت صفحات</span><i class="fas fa-building fa-fw me-3 text-white text-center"></i>
          </a>
          <a href="http://localhost:8000/adm/media/create" class="list-group-item list-group-item-action py-2 divv ripple bg-dark">
          <span class="pi text">بست ها</span><i class="fas fa-calendar fa-fw me-3 text-white text-center"></i>
          </a>
        </div>
      </div>
    </nav>
            ...
            <section class="mb-4 bg-dark divv">
                <div class="card bg-dark">
                    <div class="card-header py-3 text-white">
                        <h5 class="mb-0 text-center"><strong>لیست محصولات</strong></h5>
                        </div>
                        <?php            
            if(isset($boon)){
                foreach($boon as $product){
                echo $product->media_id;
                echo "<br/>";
                $src = App\Models\media::find($product->media_id)->photo_path;
                echo $src;
                echo "<br/>";
...
?> 
                    ...
                    <div class="card-body bg-dark">
                        <form action="<?php echo e(url('/')); ?>/adm/product" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <select class="divv bg-dark text-white text-center" name="product" id="product">
                                <option value="media_id"></option>
                            </select>
                            <p class="text-light text-center"> عکس جدید برای محصولات</p>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\kiarash\Desktop\an\resources\views/admin/product/index.blade.php ENDPATH**/ ?>